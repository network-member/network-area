...
The idea is to have a room for projects which life cycle is handled fully on my own: from planning to prod deployment. It may also be a portfolio, because all commercial apps I am associated with are private by known reason.
